 ...
 */
class CRM_Firewall_Upgrader_Base {

  /**
   * @var CRM_Firewall_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Firewall_Upgrader(
        'firewall',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Firewall_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Firewall_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
